...
const questions = [
  {
    title:
      "Which of the following functions combines the text of two strings and returns the new string?",
    choices: ["add()", "converge()", "concat()"],
    answer: "concat()",
  },
  {
    title:
      "Which of the following functions adds or removes elements from an array?",
